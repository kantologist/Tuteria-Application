...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FrontPageBanner'
        db.create_table(u'guinnessnigeria_frontpagebanner', (
        ...
        db.send_create_signal(u'guinnessnigeria', ['FrontPageBanner'])

        # Adding model 'SocialMedia'
        db.create_table(u'guinnessnigeria_socialmedia', (
        ...
        db.send_create_signal(u'guinnessnigeria', ['SocialMedia'])


    def backwards(self, orm):
        # Deleting model 'FrontPageBanner'
        db.delete_table(u'guinnessnigeria_frontpagebanner')

        # Deleting model 'SocialMedia'
        db.delete_table(u'guinnessnigeria_socialmedia')
    ...
    models = {
        ...
        u'guinnessnigeria.frontpagebanner': {
            'Meta': {'ordering': "['order']", 'object_name': 'FrontPageBanner', '_ormbases': [u'unobase.ContentModel']},
