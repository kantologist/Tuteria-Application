...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('brands_brandcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=50)),
        ))
        db.send_create_signal('brands', ['BrandCategory'])

        # Adding model 'Brand'
        db.create_table('brands_brand', (
            ('contentmodel_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['unobase.ContentModel'], unique=True, primary_key=True)),
        ...
        db.create_table('brands_brandcategorythrough', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('brands', ['BrandCategoryThrough'])


    def backwards(self, orm):
        # Deleting model 'BrandCategory'
        db.delete_table('brands_brandcategory')

        # Deleting model 'Brand'
        db.delete_table('brands_brand')

        # Deleting model 'BrandCategoryThrough'
        db.delete_table('brands_brandcategorythrough')
